...
// Lazy initialization to avoid loading fabric during preload phase
let resizeControl: fabric.Control | undefined;
let rotateControl: fabric.Control | undefined;
let deleteControl: fabric.Control | undefined;

function getResizeControl(): fabric.Control {
  if (!resizeControl) {
...
function getRotateControl(): fabric.Control {
  if (!rotateControl) {
...
function getDeleteControl(): fabric.Control {
  if (!deleteControl) {
...
export const customFabricObjectControls = {
  get br() {
    return getResizeControl();
  },
  get mtr() {
    return getRotateControl();
  },
  get tl() {
    return getDeleteControl();
  },
};
